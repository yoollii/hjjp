...
var _LoadingHtml = '<div id="loadingDiv" style="position:fixed;left:0;width:100%;height:' 
	...
	+ 'px; width: auto; height: 57px; line-height: 57px; padding-left: 50px; padding-right: 5px; background: #fff url(/qlms/static/images/loaders/loader6.gif) no-repeat scroll 5px 10px; border: 2px solid #95B8E7; color: #696969; font-family:\'Microsoft YaHei\';">页面加载中，请等待...</div></div>';  
//呈现loading效果  
